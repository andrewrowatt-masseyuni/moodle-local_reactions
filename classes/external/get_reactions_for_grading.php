 ...
 */
class get_reactions_for_grading extends external_api {
    /**
    ...
    /**
     * Get reactions for the given items in the grading panel context.
     *
     * When the per-forum "Only show peer reactions when grading" option is enabled,
     * self-reactions and reactions by non-students are excluded from the result.
     *
    ...
    public static function execute(
        ...
        $reactions = manager::get_reactions_for_grading(
            $params['component'],
            $params['itemtype'],
            $params['itemids'],
            $USER->id,
